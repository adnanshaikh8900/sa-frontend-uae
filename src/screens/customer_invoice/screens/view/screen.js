		...
		return (
			<div className="view-invoice-screen">
				<div className="animated fadeIn">
					...
					<div style={{ display: this.state.creditNoteDataList.length === 0 ? 'none' : '' }}><strong>{strings.CreditNoteIssuedonCustomerInvoice}</strong></div>
					<Card>

						<div style={{ display: this.state.creditNoteDataList.length === 0 ? 'none' : '' }} >
							<Table  >
