...
const PayrollSummary = [
    ...
    {
        field: 'payPeriod', headerName: 'Pay Period', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            ...
            return (
                <div>
                    <Table className=''>
                        <Row className='m-0'><b>Start-Date:</b> {startDate}</Row>
                        <Row className='m-0'><b>End-Date:</b> {endDate}</Row>
                    </Table>
                </div>
            )
        }
    ...
    {
        field: 'totalAmount', headerName: 'Total Amount', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
    ...
    {
        field: 'dueAmount', headerName: 'Due Amount', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const SalesByCustomer = [
    ...
    {
        field: 'salesExcludingvat', headerName: strings.SalesExcludingTax, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.salesExcludingvat);
        }
    },
    {
        field: 'getSalesWithVat', headerName: strings.SalesWithTax, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const ExpenseDetails = [
    ...
    { field: 'transactionCategoryName', headerName: strings.ExpenseCategory, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'status', headerName: strings.Status, headerClassName: "table-header-bg", flex: 1, headerAlign: 'center', align: 'center', },
    { field: 'expenseNumber', headerName: strings.ExpenseNumber, headerClassName: "table-header-bg", flex: 1, headerAlign: 'center', align: 'center', },
    { field: 'payMode', headerName: strings.PaymentMode, headerClassName: "table-header-bg", flex: 1, headerAlign: 'center', align: 'center', },
    { field: 'vatName', headerName: strings.VATCategory, headerClassName: "table-header-bg", flex: 1, headerAlign: 'center', align: 'center', },
    {
        field: 'expenseVatAmount', headerName: strings.VatAmount, headerClassName: "table-header-bg", flex: 1, headerAlign: 'right', align: 'right', renderCell: (params) => {
            return renderAmount(params.row.expenseVatAmount);
        }
    },
    {
        field: 'amountWithoutTax', headerName: strings.Amount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.amountWithoutTax);
        }
    },
    {
        field: 'expenseAmount', headerName: strings.Amount + " " + strings.WithTax, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const ExpenseByCategoryDetails = [
    ...
    {
        field: 'expensesAmountWithoutTaxSum', headerName: strings.Amount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.expensesAmountWithoutTaxSum);
        }
    },
    {
        field: 'expensesAmountSum', headerName: strings.Amount + " " + strings.WithTax, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const ReceivableInvoiceSummary = [
    ...
    { field: 'customerName', headerName: strings.CustomerName, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceDate', headerName: strings.InvoiceDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceDueDate', headerName: strings.InvoiceDueDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'status', headerName: strings.Status, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    {
        field: 'invoiceTotalAmount', headerName: strings.InvoiceAmount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.invoiceTotalAmount);
        }
    },
    {
        field: 'balance', headerName: strings.RemainingBalance, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const PurchaseByVendor = [
    ...
    {
        field: 'getSalesWithvat', headerName: strings.Purchase + " " + strings.WithTax, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.getSalesWithvat);
        }
    },
]
...
const TaxCreditNoteDetails = [
    ...
    { field: 'customerName', headerName: strings.CustomerName, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceNumber', headerName: strings.InvoiceNumber, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'creditNoteDate', headerName: strings.CreditNoteDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'status', headerName: strings.Status, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    {
        field: 'creditNoteTotalAmount', headerName: strings.SalesReturn, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
...
const TaxDebitNoteDetails = [
    ...
    { field: 'customerName', headerName: strings.SupplierName, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceNumber', headerName: strings.InvoiceNumber, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'creditNoteDate', headerName: strings.DebitNoteDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'status', headerName: strings.Status, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    {
        field: 'creditNoteTotalAmount', headerName: strings.Amount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.creditNoteTotalAmount);
        }
    },
    {
...
const PayableInvoiceSummary = [
    ...
    { field: 'supplierName', headerName: strings.SupplierName, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceDate', headerName: strings.InvoiceDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'invoiceDueDate', headerName: strings.InvoiceDueDate, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    { field: 'status', headerName: strings.Status, headerAlign: 'center', headerClassName: "table-header-bg", flex: 1, align: 'center', },
    {
        field: 'totalInvoiceAmount', headerName: strings.InvoiceAmount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.totalInvoiceAmount);
        }
    },
    {
        field: 'balance', headerName: strings.DueBalance, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return renderAmount(params.row.balance);
        }
    },
]
...
const PayableInvoiceDetails = [
    ...
    {
        field: 'vatAmount', headerName: strings.VatAmount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return params.row.vatAmount === null || params.row.vatAmount === 0 ? '' : renderAmount(params.row.vatAmount);
        }
    },
    {
        field: 'totalAmount', headerName: strings.Total + " " + strings.Amount, headerAlign: 'right', align: 'right', headerClassName: "table-header-bg", flex: 1, renderCell: (params) => {
            return params.row.totalAmount === null || params.row.totalAmount === 0 ? '' : renderAmount(params.row.totalAmount);
        }
    },
]
