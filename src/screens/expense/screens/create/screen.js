  ...
  if (list.length !== 0) {
    ...
    COAList.map((transactionCategoryDescription) => {
      ...
      let sub_Cat = list.filter(
        (subCat) =>
          subCat.transactionCategoryDescription ===
...
const mapStateToProps = (state) => {
  const expenseCategoryList = SortExpenseCategory(
    state?.expense?.expense_categories_list
  );
  return {
          ...
          this.setState(
            {
              ...
              initValue: {
                ...
                placeOfSupplyId: res.data.placeOfSupplyId
                  ...
                  : "",
                taxTreatmentId: res.data.taxTreatmentId
                  ? res.data.taxTreatmentId
                  : "",
                notes: res.data.notes ? res.data.notes : "",
              },
              payee: res.data.payee ? res.data.payee : "",
              expenseType: res.data.expenseType ? true : false,
              isVatClaimable: res.data.isVatClaimable
                ? res.data.isVatClaimable
                : false,
            ...
            () => {
              ...
              let currency = selectCurrencyFactory
                .renderOptions(
                  "currencyName",
                  "currencyCode",
                  this.props.currency_convert_list,
                  "Currency"
                )
  ...
  getcurentCompanyUser = () => {
    this.props.expenseCreateActions.checkAuthStatus().then((response) => {
      ...
      this.setState({
        ...
        companyVATRegistrationDate: new Date(
          response.data.company.vatRegistrationDate
        ),
      });
    });
  };
                            ...
                            {(props) => (
                              <Form onSubmit={props.handleSubmit}>
                                        ...
                                        <Select
                                          ...
                                          onChange={(option) => {
                                            ...
                                            if (option && option.value) {
                                              ...
                                              this.placelistSetting(
                                                option,
                                                props
                                              );
                                              // ReverseCharge setup
                                              this.ReverseChargeSetting(
                                                option.value,
                                                props
                                              );
                                              this.setState({
                                    ...
                                    <FormGroup className="mb-3">
                                      ...
                                      <DatePicker
                                        ...
                                        onChange={(value) => {
                                          ...
                                          this.setState({
                                            expenseDateForVatValidation: value,
                                          });
                                      ...
                                      {props.errors.expenseDate &&
                                        props.touched.expenseDate && (
                                          <div className="invalid-feedback">
                                            {props.errors.expenseDate.includes(
                                              "final value was:"
                                            )
                                ...
                                {props.values.vatCategoryId !== "" &&
                                  props.values.vatCategoryId.label !==
                                    "Select VAT" &&
