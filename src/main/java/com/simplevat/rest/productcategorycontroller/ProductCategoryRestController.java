...
public class ProductCategoryRestController {
	...
	public ResponseEntity getAllTransactionCategory(HttpServletRequest request) {
		...
		List<ProductCategory> produxtcategories = productCategoryService.findAllProductCategoryByUserId(userId,true);
		if (produxtcategories != null) {
			return new ResponseEntity(productCategoryRestHelper.getListModel(produxtcategories), HttpStatus.OK);
		}
