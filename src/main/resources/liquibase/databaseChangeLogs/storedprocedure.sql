...
#
DROP PROCEDURE IF EXISTS `profitAndLossStoredProcedure`;
#
#
CREATE PROCEDURE `profitAndLossStoredProcedure`(IN `incomeCode` VARCHAR(255), IN `costOfGoodsSoldCode` VARCHAR(255), IN `adminExpenseCode` VARCHAR(255), IN `otherExpenseCode` VARCHAR(255), IN `startDate` DATE, IN `endDate` DATE)
    NO SQL
BEGIN
...
#
DROP PROCEDURE IF EXISTS `taxesStoredProcedure`;
#
#
CREATE PROCEDURE `taxesStoredProcedure`( IN `inputVatCode` VARCHAR(255), IN `outputVatCode` VARCHAR(255),IN `startDate` DATE, IN `endDate` DATE)
    NO SQL
BEGIN
