...
public class TransactionCategoryRestController implements Serializable {
    ...
    public ResponseEntity getAllTransactionCategory(HttpServletRequest request) {
        ...
        List<TransactionCategory> transactionCategories = transactionCategoryService.findAllTransactionCategoryByUserId(userId);
    ...
    public ResponseEntity update(@RequestBody TransactionCategoryBean transactionCategoryBean, HttpServletRequest request) {
        try {
            Integer userId = jwtTokenUtil.getUserIdFromHttpRequest(request);
            User user = userServiceNew.findByPK(userId);
            TransactionCategory selectedTransactionCategory = transcationCategoryHelper.getEntity(transactionCategoryBean);
