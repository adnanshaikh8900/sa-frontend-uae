...
class EmployeeFinancial extends React.Component {
  ...
  initializeData = (search) => {
    ...
    this.props.employeeActions.getEmployeeList(postData).then((res) => {
      ...
      this.setState({ loading: false })
      this.props.commonActions.tostifyAlert('error', err && err.data ? 
                    ...
                    <Col lg={12}>
                      <div className="d-flex justify-content-end">
                        ...
                        <Button
                            ...
                            onClick={() => this.props.history.push(`/admin/payroll/financial/create`)}
                          >
                      ...
                      <div>
                        <BootstrapTable
                          ...
                          data={employee_list && employee_list.data ? 
                            employee_list.data : []}
                          version="4"
                          hover
                          pagination={employee_list && 
                            employee_list.data && 
                            employee_list.data.length > 0 ? true : false}
                          keyField="id"
                          remote
                          fetchInfo={{ dataTotalSize: employee_list.count ?
                             employee_list.count : 0 }}
...
export default connect(mapStateToProps, mapDispatchToProps)(EmployeeFinancial)
