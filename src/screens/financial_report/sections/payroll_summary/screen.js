										...
										<div id="tbl_exporttable_to_xls" className="table-wrapper">
											<Table >
												<thead className="header-row" >
													<tr>
														<th style={{ padding: '0.5rem', textAlign: 'center' ,width:"10%"}}>	Payroll Date</th>
														<th style={{ padding: '0.5rem', textAlign: 'center', width:"25%"}}>	Payroll Subject</th>
														<th style={{ padding: '0.5rem', textAlign: 'center',width:"25%" }}>	Pay Period</th>
														<th style={{ padding: '0.5rem', textAlign: 'center' ,width:"15%"}}>Employee Count</th>
														<th style={{ padding: '0.5rem', textAlign: 'center',width:"20%" }}>	Generated by</th>
														<th style={{ padding: '0.5rem', textAlign: 'center' }}>	Approver</th>
														<th style={{ padding: '0.5rem', textAlign: 'center' ,width:"10%" }}>Run Date</th>
