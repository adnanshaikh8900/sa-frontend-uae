    ...
    this.props.generalSettingActions.getGeneralSettingDetail().then((res) => {
      if (res.status === 200) {
        this.setState({
          ...
          selected_smtp_enable: res.data.mailingSmtpStarttlsEnable ? res.data.mailingSmtpStarttlsEnable : '',
        },() => {
          this.content = { "entityMap": {}, "blocks": [{ "key": "637gr", "text": this.state.message, "type": "unstyled", "depth": 0, "inlineStyleRanges": [], "entityRanges": [], "data": {} }] };
          this.setState({
            viewEditor: true
          })
        })
                ...
                <Row>
                  <Col>
                    <Formik
                      ...
                      validationSchema={
                        Yup.object().shape({
                          invoicingReferencePattern: Yup.string().required("Invoice Reference Number is Required"),
                      ...
                      {(props) => (
                        <Form onSubmit={props.handleSubmit}>
                          ...
                          <Row>
                            <Col sm="6">
                              <FormGroup>
                                <Label htmlFor="invoicingReferencePattern"> Invoicing Reference Pattern</Label>
                                <Input
                                  type="text"
                                ...
                                />
                                {props.errors.invoicingReferencePattern && props.touched.invoicingReferencePattern && (
                                  <div className="invalid-feedback">{props.errors.invoicingReferencePattern}</div>
                                )}
                              </FormGroup>
                            </Col>
                            {/* <Col sm="6">
                          ...
                          <Row>
                            <Col sm='6'>
                              <FormGroup>
                                <Label htmlFor="mailingHost">Mailing Host</Label>
                                <Input
                                  type="text"
                                  id="mailingHost"
                                  name="mailingHost"
                                  ...
                                  onChange={(option) => { props.handleChange('mailingHost')(option) }}
                                  className={
                                    props.errors.mailingHost && props.touched.mailingHost
                                      ? "is-invalid"
                                      : ""
                                  }
                                />
                                {props.errors.mailingHost && props.touched.mailingHost && (
                                  <div className="invalid-feedback">{props.errors.mailingHost}</div>
                                )}
                              </FormGroup>
                            </Col>
                            <Col sm='6'>
                              <FormGroup>
                                <Label htmlFor="mailingPort">Mailing Port</Label>
                                <Input
                                  type="text"
                                  id="mailingPort"
                                  name="mailingPort"
                                  ...
                                  onChange={(option) => { props.handleChange('mailingPort')(option) }}
                                  className={
                                    props.errors.mailingPort && props.touched.mailingPort
                                      ? "is-invalid"
                                      : ""
                                  }
                                />
                                {props.errors.mailingPort && props.touched.mailingPort && (
                                  <div className="invalid-feedback">{props.errors.mailingPort}</div>
                                )}
                              </FormGroup>
                            </Col>
                          </Row>
                          <Row>
                            <Col sm='6'>
                              <FormGroup>
                                <Label htmlFor="mailingUserName">Mailing UserName</Label>
                                <Input
                                  type="text"
                                  id="mailingUserName"
                                  ...
                                  autoComplete="off"
                                  onChange={(option) => { props.handleChange('mailingUserName')(option) }}
                                  className={
                                    props.errors.mailingUserName && props.touched.mailingUserName
                                      ? "is-invalid"
                                      : ""
                                  }
                                />
                                {props.errors.mailingUserName && props.touched.mailingUserName && (
                                  <div className="invalid-feedback">{props.errors.mailingUserName}</div>
                                )}
                              </FormGroup>
                            </Col>
                            <Col sm='6'>
                          ...
                          <Row>
                            <Col sm='6'>
                              <FormGroup>
                                <Label htmlFor="mailingSmtpAuthorization">Mailing SMTP Authorization</Label>
                                <div>
                            ...
                            <Col sm='6'>
                              <FormGroup>
                                <Label htmlFor="mailingSmtpStarttlsEnable">Mailing Smtp Starttls Enable</Label>
                                <div>
                                  <FormGroup check inline>
                                    <div className="custom-radio custom-control">
                                      <input
                            ...
                            <Col sm="8">
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  onChange={(value) => {
                                    props.handleChange("invoiceMailingSubject")(value)
                                  }}
                                />
                              </FormGroup>
                              <FormGroup>
                            ...
                            <Col sm="4">
                              <FormGroup>
                                ...
                                <Table responsive bordered>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>{"{invoicingReferencePattern}"}</td>
