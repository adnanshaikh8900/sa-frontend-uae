const en = {
      ...
      PleaseEnter5DigitPostalZipCode: "lease enter 5 digit Postal/Zip Code",
      InvalidPostalZipCode: "Invalid Postal/Zip Code",
      PleaseEnter6DigitPostalZipCode: "Please enter 6 digit postal zip code",
      POBoxNumberIsRequired: 'PO box number is required',
      PleaseEnter3To6DigitPOBoxNumber: "Please enter 3 To 6 digit po box number",
      ...
      ExpensePostedSuccessfully: "Expense Posted Successfully",
      ExpensePostedUnsuccessfully: "Expense Posted Unsuccessfully",
      ExpenseMovedToDraftSuccessfully: "Expense Moved To Draft Successfully",
      ExpenseMovedToDraftUnsuccessfully: "Expense Moved To Draft Unsuccessfully",
      PAYEE: "PAYEE",
      Payee: "Payee",
      ...
      DebitNoteUpdatedSuccessfully: "Debit Note Updated Successfully!",
      DebitNoteUpdatedUnsuccessfully: "Debit Note Updated Unsuccessfully!",
      ...
      PleaseEnter15DigitFax:"Please enter 15 digit Fax",
      ...
      CreateAnEarningComponent: "Create an Earning Component",
      ...
      PercentOfCTC: "Percent of CTC",
      FlatAmount: "Flat Amount",
      SalaryComponentCreateNote: "The component cannot be deleted if it is linked to the employee's salary setup.",
      ComponentIDIsRequired: "Component ID is required",
      ComponentIDAlreadyExists: "Component ID already exists",
      ComponentNameIsRequired: "Component Name is required",
      ComponentNameAlreadyExists: "Component Name already exists",
      ComponentTypeTooltip: "The type of the component cannot be changed, once it is linked to the employee's salary setup.",
      Earning: "Earning",
      Deduction: "Deduction",
      PercentOfCTCIsRequired: "Percent of CTC is required",
      FlatAmountIsRequired: "Flat Amount is required",
