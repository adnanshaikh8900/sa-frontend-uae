...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    ExciseTaxAuditReportActions: bindActionCreators(
      ExciseTaxAuditReportActions,
      dispatch
    ),
  };
};
...
class VatSettingModal extends React.Component {
  ...
  handleSubmit = (data, resetForm, setSubmitting) => {
    ...
    this.props.ExciseTaxAuditReportActions.VATSetting(formData)
      .then((res) => {
        if (res.status === 200) {
  ...
  render() {
    ...
    const { openModal, closeModal, current_report_id, endDate, taxReturns } =
      this.props;
        ...
        <Modal isOpen={openModal} className="modal-success contact-modal">
          ...
          <Formik
            ...
            validate={(values) => {
              let errors = {};
              if (
                values.taxablePersonNameInEnglish &&
                this.regExAlpha.test(values.taxablePersonNameInEnglish) != true
              )
                errors.taxablePersonNameInEnglish =
                  "A taxable person's name must contain only alphabets";
              if (
                values.taxablePersonNameInArabic &&
                this.regExAlpha.test(values.taxablePersonNameInArabic) != true
              )
                errors.taxablePersonNameInArabic =
                  "A taxable person's name must contain only alphabets";
              if (
                values.taxAgentName &&
                this.regExAlpha.test(values.taxAgentName) != true
              )
                errors.taxAgentName =
                  "Tax agent name must contain only alphabets";
              if (
                values.taxAgencyName &&
                this.regExAlpha.test(values.taxAgencyName) != true
              )
                errors.taxAgencyName =
                  "Tax agency name must contain only alphabets";
              if (
                values.taxAgentApprovalNumber &&
                this.regEx.test(values.taxAgentApprovalNumber) != true
              )
                errors.taxAgentApprovalNumber =
                  "TAAN must contain 8 digits number";
              if (
                values.taxAgencyNumber &&
                this.regExBoth.test(values.taxAgencyNumber) != true
              )
                errors.taxAgencyNumber = "TAN must contain only alphanumeric";
              if (
                values.taxAgencyNumber &&
                values.taxAgencyNumber.length !== 10
              ) {
                errors.taxAgencyNumber =
                  "TAN must contain 10 digits alphanumeric";
              }
              if (
                values.taxAgentApprovalNumber &&
                values.taxAgentApprovalNumber.length !== 8
              ) {
                errors.taxAgentApprovalNumber =
                  "TAAN must contain 8 digits number";
              }
                ...
                >
                  <ModalBody>
                    <Row>
                        ...
                        <FormGroup className="mb-3">
                          ...
                          <Input
                            ...
                            onChange={(option) => {
                              ...
                              props.handleChange("taxablePersonNameInEnglish")(
                                option
                              );
                            }}
                            defaultValue={
                              props.values.taxablePersonNameInEnglish
                            }
                            className={
                      ...
                      <Col lg={4}>
                        <FormGroup className="mb-3">
                          ...
                          <Input
                            ...
                            onChange={(option) =>
                              props.handleChange("taxablePersonNameInArabic")(
                                option
                              )
                            }
                            defaultValue={
                              props.values.taxablePersonNameInArabic
                            }
                            className={
                      ...
                      <Col lg="4">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            placeholder={
                              strings.Enter + strings.TaxRegistrationNumber
                            }
                            onChange={(option) => {
                              if (
                                option.target.value === "" ||
                      ...
                      <Col lg={4}>
                        <FormGroup className="mb-3">
                          ...
                          <Input
                            ...
                            className={
                              props.errors.taxAgencyName ? "is-invalid" : ""
                            }
                          />
                      ...
                      <Col lg={4}>
                        <FormGroup className="mb-3">
                          {this.state.isTANMandetory === true && (
                            <span className="text-danger"> </span>
                          )}
                          <Label htmlFor="taxAgencyNumber">
                          ...
                          <Input
                            ...
                            className={
                              props.errors.taxAgencyNumber ? "is-invalid" : ""
                            }
                          />
                      ...
                      <Col lg={4}>
                        <FormGroup className="mb-3">
                          ...
                          <Input
                            ...
                            className={
                              props.errors.taxAgentName ? "is-invalid" : ""
                            }
                          />
                      ...
                      <Col lg={4}>
                        <FormGroup className="mb-3">
                          ...
                          <Input
                            ...
                            autoComplete="off"
                            placeholder={
                              "Enter Tax Agent Approval Number (TAAN)"
                            }
                            onChange={(option) => {
                              if (
                                option.target.value === "" ||
                                ...
                                props.handleChange("taxAgentApprovalNumber")(
                                  option
                                );
                              } else {
                                props.handleChange("taxAgentApprovalNumber")(
                  ...
                  <ModalFooter>
                    ...
                    >
                      ...
                      {this.state.disabled ? "Saving..." : strings.Save}
                    </Button>
                    &nbsp;
                    <Button
                      color="secondary"
