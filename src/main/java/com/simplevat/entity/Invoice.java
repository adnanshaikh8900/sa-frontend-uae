...
@NamedQueries({
		...
		@NamedQuery(name = "suggestionUnpaidInvoices", query = "from Invoice i where i.status in :status and  i.contact.contactId = :id and  i.type =:type and i.deleteFlag = false and i.totalAmount >= :amount order by i.id desc ")
