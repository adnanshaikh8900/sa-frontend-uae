...
export const getCustomerAccountStatement = (postData) => {
  const { startDate, endDate, contactId } = postData;
  let url = `/rest/simpleaccountReports/statementOfAccounts?startDate=${startDate}&endDate=${endDate}${
